...
- [ ] INV-FIX (id:86b5) — v1 correctness fixes: amender-clobber idempotence, per-record date, id validation, table escaping (Fable review). SHIP BEFORE real use. See ROADMAP + docs/fable-session-review-2026-07-11.md.
